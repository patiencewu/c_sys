...
function checkUser(){
  ...
  if(pa==""){alert("用户名不能为空");return false;}
  ...
  <div class="account">
    <input name="userName" type="text" style="width:339px; height:29px; border: 0px; font-size: 18px; vertical-align: middle;" />
  </div>
  ...
  <div class="key">
    <input name="password" type="password" style="width:339px; height:29px; border: 0px; font-size: 30px; vertical-align:middle;" maxlength="16"/>
  </div>
  ...
  <div onclick="checkUser();" class="logButton"><a href="#"><input type="submit" src="images/images/log_11.jpg"/></a></div>
  </form>
  ...
  <div class="newButton"><a href="#"><img src="images/images/log_15.jpg" /></a></div>
